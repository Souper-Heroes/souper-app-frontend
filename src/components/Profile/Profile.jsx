                ...
                <GridContainer>
                  <GridItem xs={12} sm={12} md={6}>
                    ...
                    />
                     ...
                     />
                     <InputLabel id="demo-simple-select-label">Item distance</InputLabel>
                        <Select
                  ...
                  <GridItem xs={12} sm={12} md={6}>
                    ...
                    />
                    <Button variant="contained" color="success" size="lg">CHANGE AVATAR</Button>
                    <Button variant="contained" size="lg">DELETE ACCOUNT</Button>
                  </GridItem>
                  <GridItem xs={12} sm={12} md={6}>
                    <Button variant="contained" color="rose" size="lg">SAVE CHANGES</Button>
                  </GridItem>
                </GridContainer>
              </form>
          </GridItem>
